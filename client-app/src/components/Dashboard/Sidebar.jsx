...
const Sidebar = ({ activeSection, setActiveSection }) => {
  ...
  return (
    <motion.div
      initial={{ x: -300 }}
      animate={{ x: 0 }}
      className={`bg-white shadow-lg border-r border-gray-200 h-full transition-all duration-300 ${isCollapsed ? 'w-16' : 'w-64'
        }`}
    >
      {/* Header */}
        ...
        <div className="flex items-center justify-between">
          {!isCollapsed && (
            <div>
              ...
              <p className="text-sm text-gray-500">Liliana - Admin</p>
            </div>
          )}
          <button
