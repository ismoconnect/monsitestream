  ...
  const pastSessions = [
    {
      ...
      price: 50,
      rating: 5,
      feedback: 'Moment magique, Sophie est exceptionnelle'
    },
    {
      id: 2,
            ...
            <div className="bg-black rounded-lg aspect-video relative overflow-hidden">
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center text-white">
                  ...
                  <p className="text-gray-400">Connexion en cours avec Sophie</p>
                </div>
              </div>
              ...
              <div className="flex-1 p-3 overflow-y-auto">
                <div className="space-y-2">
                  <div className="text-sm">
                    <span className="font-medium text-purple-600">Sophie:</span>
    ...
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">Rejoignez Sophie en direct pour des moments exclusifs</p>
        </div>
        <div className="flex items-center space-x-2">
            ...
            {pastSessions.map((session, index) => (
              <motion.div
                ...
                className={`p-6 flex items-center justify-between ${
                  index < pastSessions.length - 1 ? 'border-b' : ''
                }`}
              >
