  ...
  const content = [
    {
      ...
      type: 'photo',
      category: 'public',
      thumbnail: 'https://images.unsplash.com/photo-1494790108755-2616b612b786?w=600&h=800&fit=crop&crop=face',
    ...
    },
    {
      ...
      type: 'photo',
      category: 'premium',
      thumbnail: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?w=600&h=800&fit=crop&crop=face',
      title: 'Séance Intime',
      date: '2024-01-14',
      views: 45,
      likes: 12,
    ...
    },
    {
      ...
      type: 'video',
      category: 'premium',
      thumbnail: 'https://images.unsplash.com/photo-1524504388940-b1c1722653e1?w=600&h=800&fit=crop&crop=face',
      title: 'Moment Privé',
      date: '2024-01-13',
      views: 234,
      likes: 67,
      isExclusive: true,
      description: 'Vidéo exclusive réservée aux abonnés',
      tags: ['vidéo', 'privé', 'exclusif'],
      duration: '2:34'
    },
    {
      id: 4,
      type: 'photo',
      category: 'public',
      thumbnail: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=600&h=800&fit=crop&crop=face',
    ...
    },
    {
      ...
      type: 'video',
      category: 'vip',
      thumbnail: 'https://images.unsplash.com/photo-1529626455594-4ff0802cfb7e?w=600&h=800&fit=crop&crop=face',
    ...
    },
    {
      ...
      type: 'photo',
      category: 'public',
      thumbnail: 'https://images.unsplash.com/photo-1506863530036-1efeddceb993?w=600&h=800&fit=crop&crop=face',
      title: 'Style Moderne',
      date: '2024-01-10',
      views: 567,
      likes: 98,
    ...
    },
    {
      ...
      type: 'photo',
      category: 'premium',
      thumbnail: 'https://images.unsplash.com/photo-1488426862026-3ee34a7d66df?w=600&h=800&fit=crop&crop=face',
      title: 'Mystère et Séduction',
      date: '2024-01-09',
      views: 156,
      likes: 34,
      isExclusive: true,
      description: 'L\'art de la séduction dans toute sa subtilité',
      tags: ['séduction', 'mystère', 'art']
    },
    {
      id: 8,
      type: 'video',
      category: 'vip',
      thumbnail: 'https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?w=600&h=800&fit=crop&crop=face',
      title: 'Luxe Absolu',
      date: '2024-01-08',
      views: 45,
      likes: 18,
      isExclusive: true,
      description: 'Le summum du raffinement et de l\'élégance',
      tags: ['luxe', 'raffinement', 'élégance'],
      duration: '3:28'
    }
  ];
            ...
            <div className="flex items-center mb-3">
              ...
              <div className="ml-4">
                ...
                <p className="text-sm sm:text-base text-gray-600 mt-1">
                  Découvrez l'univers raffiné de Sophie
                </p>
              </div>
            </div>
          ...
          <div className="flex flex-wrap gap-3">
            {categories.map(category => (
              <motion.button
                ...
                className={`relative px-6 py-3 font-medium transition-all duration-300 rounded-xl text-sm ${
