  ...
  return (
    <div className="bg-white rounded-lg shadow-lg overflow-hidden h-full">
      <div className="flex h-full">
        ...
        <div className={`w-full lg:w-80 border-r border-gray-200 bg-gray-50 flex-shrink-0 flex flex-col ${
              ...
              conversations.map((conversation) => {
                ...
                return (
                  <motion.div
                    ...
                    className={`p-3 lg:p-4 border-b border-gray-200 cursor-pointer transition-colors ${
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center space-x-2">
                      <div className={`w-2 h-2 rounded-full ${
                        clientPresence.isOnline ? 'bg-green-400 animate-pulse' : 'bg-gray-400'
                      }`}></div>
          ...
          return (
            ...
            >
              <div className="max-w-[85%] sm:max-w-xs lg:max-w-md">
                ...
                <div
                  className={`px-3 py-2 lg:px-4 lg:py-3 rounded-2xl shadow-sm ${
                    isAdmin
      ...
      <div className="border-t border-gray-200 bg-white flex-shrink-0">
        ...
        <div className="p-2 bg-gradient-to-r from-pink-50 to-purple-50 border-b border-pink-100">
          <p className="text-xs text-pink-700 font-medium text-center">
            💬 Répondre en tant que <strong>Sophie</strong>
          </p>
        </div>
                  ...
                  >
                    <motion.button
                      ...
                      className={`w-full flex items-center space-x-3 p-2 rounded-lg transition-colors text-left ${
                        clientHasPremiumAccess() ? 'text-gray-700' : 'text-gray-400'
                      }`}
                    >
                      <div className="relative">
