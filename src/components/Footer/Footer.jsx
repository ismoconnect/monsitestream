        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          >
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-2xl font-bold">Sophie</h3>
            </div>
          ...
          >
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#subscriptions" className="text-gray-300 hover:text-pink-400 transition-colors">
                  Abonnements
                </a>
              </li>
              <li>
          ...
          >
            ...
            <div className="space-y-3">
              <div className="flex items-center">
                ...
                <span className="text-gray-300 text-sm">sophie@contact.com</span>
              </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-6">
              ...
              <span className="text-gray-500 text-sm">
                © 2024 Sophie. Tous droits réservés.
              </span>
            </div>
          </div>
        </motion.div>
