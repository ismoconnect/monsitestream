      ...
      <div className="bg-gradient-to-r from-pink-500 to-purple-600 text-white p-3 sm:p-4 shadow-lg">
        <div className="flex items-center space-x-4">
          ...
          <div className="flex-1">
            <h1 className="text-lg font-bold">Liliana</h1>
            <div className="text-pink-100 text-sm flex items-center">
              <div className={`w-2 h-2 rounded-full mr-2 ${adminPresence.isOnline ? 'bg-green-400 animate-pulse' : 'bg-gray-400'
                }`}></div>
              <span>
          ...
          <div className="flex items-center space-x-2">
            ...
            <motion.button
              ...
              className={`p-2 rounded-full transition-colors ${isPremiumUser()
              ...
              return (
                ...
                >
                  <div className={`max-w-[85%] sm:max-w-xs lg:max-w-md xl:max-w-lg`}>
                    ...
                    {/* Bulle de message */}
                    <div
                      className={`px-3 py-2 sm:px-4 sm:py-3 rounded-2xl shadow-sm ${isOwn
                ...
                {showOptions && (
                  ...
                  >
                    <motion.button
                      ...
                      className={`w-full flex items-center space-x-3 p-2 rounded-lg transition-colors text-left ${isPremiumUser() ? 'text-gray-700' : 'text-gray-400'
                        }`}
                    >
                      <div className="relative">
              ...
              <div className="p-6">
                <div className="text-center mb-6">
                  ...
                  <p className="text-gray-600 text-sm leading-relaxed">
                    Mettez à niveau votre abonnement pour accéder à toutes les fonctionnalités exclusives et profiter d'une expérience complète avec Liliana !
                  </p>
                </div>
