...
const ClientStreamingSectionSimple = ({ currentUser }) => {
  ...
  if (!isPremium) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-pink-50 p-4 sm:p-6">
        <motion.div 
            ...
            {filters.map((filter) => {
              ...
              return (
                <motion.button
                  ...
                  className={`flex items-center gap-2 px-3 sm:px-4 py-2 sm:py-2.5 rounded-lg sm:rounded-xl font-medium transition-all duration-200 ${
